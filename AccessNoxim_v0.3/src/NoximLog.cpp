...
void NoximLog::BufferLog( NoximNoC *n ){
	...
	if(!_mkdir("results/buffer")) cout<<"Making new directory results/buffer"<<endl;
...
void NoximLog::TrafficLog( NoximNoC *n ){
	...
	if(!_mkdir("results/STLD")) cout<<"Making new directory results/STLD"<<endl;
...
void NoximLog::PowerLog(){
	if(!_mkdir("results/POWER")) cout<<"Making new directory results/POWER"<<endl;
...
void NoximLog::Throughput   (             ){
	if(!_mkdir("results/TransientThroughput")) cout<<"Making new directory results/TransientThroughput"<<endl;
